...
export class StatusBarManager {
  ...
  constructor() {
    ...
    this.item.command = 'ai-autocomplete.toggle';
    this.showIdle();
    this.item.show();
  }
  ...
  showOn(): void {
    ...
    this.item.tooltip = 'AI Autocomplete is ON (click to toggle)';
  ...
  showOff(): void {
    ...
    this.item.tooltip = 'AI Autocomplete is OFF (click to toggle)';
    this.item.backgroundColor = undefined;
  }
  ...
  showIdle(): void {
    this.stopLoading();
    this.item.text = '$(sparkle) AI';
    this.item.tooltip = 'AI Autocomplete ready (click to toggle)';
    this.item.backgroundColor = undefined;
  }
